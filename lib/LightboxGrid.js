...
var _reactImages3 = require('@palustris/react-images');

var _reactImages4 = _interopRequireDefault(_reactImages3);
...
function LightboxGrid(props) {
    ...
    var openLightbox = function openLightbox(event, firstImage) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactImages3.ModalGateway,
            null,
            lightboxIsOpen ? _react2.default.createElement(
                _reactImages3.Modal,
                { onClose: closeLightbox },
                _react2.default.createElement(_reactImages4.default, { views: images,
                    currentIndex: currentImage,
                    styles: { view: function view(base, state) {
                            return _extends({}, base, { height: "90vh" });
                        } }
                })
            ) : null
        )
...
LightboxGrid.propTypes = {
    imageSource: _propTypes2.default.string.isRequired // The name of the field that contains the url of the image
};