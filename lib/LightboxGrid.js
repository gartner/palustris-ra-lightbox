...
var _reactImages = require('@palustris/react-images');
...
function LightboxGrid(props) {
    ...
    var imageSource = props.imageSource,
        type = props.type,
        rest = _objectWithoutProperties(props, ['imageSource', 'type']);
